...
createStyles(){
    ...
    link.href=`https://cdn.jsdelivr.net/gh/mudi-3D/offcorss@latest/index.css`; /* custom this path */
        ...
        <div class="iframeMudi3D">
            ...
            <div class="containerBtnsActions">
                ...
                <defs>
                    ...
                    .cls-2_modal{font-family:FrutigerBold, Frutiger;font-size:19.04px;fill:black}
                    .cls-3_modal{stroke-width:0px;fill:black;}
                    </style>
                </defs>
